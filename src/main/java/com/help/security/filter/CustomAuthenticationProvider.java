...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        final LoginUser loginUser = (LoginUser) memberService.loadUserByUsername(userName);
        ...
        memberService.updateMemberLastLogin(userName);
    ...
    //     LoginUser loginUser = (LoginUser) memberService.loadUserByUsername(userName);
