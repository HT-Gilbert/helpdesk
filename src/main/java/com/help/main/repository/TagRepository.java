...
public interface TagRepository extends JpaRepository<Tag, Long>{
    ...
    static final String SELECT_USER_TAG_BOARDID= "SELECT * FROM tag_list "
			+ "WHERE CAST(board_priority as signed) >= CAST(:strRolePriority as signed)";
    ...
    @Query(value = SELECT_USER_TAG_BOARDID, nativeQuery = true)
	public List<Tag> findByboardPriority(@Param("strRolePriority") String strRolePriority);
