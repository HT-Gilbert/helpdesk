...
import com.help.board.dto.BoardFileRequestDto;
import com.help.board.dto.BoardFileResponseDto;
import com.help.board.service.BoardFileService;
...
public class BoardFileController {
	...
	public String updateDeleteYn(Model model, BoardFileRequestDto boardFileRequestDto) throws Exception {
		try {
			model.addAttribute("result", boardFileService.updateFileIsDelete(boardFileRequestDto.getIdArr()));
		} catch (Exception e) {
			throw new Exception(e.getMessage());
		}
