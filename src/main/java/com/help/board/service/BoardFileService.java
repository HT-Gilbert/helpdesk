...
import com.help.board.dto.BoardFileResponseDto;
import com.help.board.entity.BoardFile;
import com.help.board.repository.BoardFileRepository;
...
public class BoardFileService {
	...
	public List<BoardFile> findByBoardIdAndBoardTable(Long boardId, String boardTable) throws Exception {
		return boardFileRepository.findByBoardIdAndBoardTable(boardId, boardTable);
	}
	...
	public boolean uploadFile(MultipartHttpServletRequest multiRequest, Long boardId, String boardTable) throws Exception {
	...
	public int updateFileIsDelete(Long[] deleteIdList) throws Exception {
		return boardFileRepository.updateFileIsDelete(deleteIdList);
	}
	
	public int deleteBoardIsDelete(String boardTable, Long[] boardIdList) throws Exception {
		return boardFileRepository.deleteBoardIsDelete(boardTable, boardIdList);
	}
}